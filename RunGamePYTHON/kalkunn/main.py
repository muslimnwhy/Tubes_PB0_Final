...
def introscreen():
    ...
    while not gameStart:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_SPACE or event.key == pygame.K_UP:
                        tempp_kalkun.isJumping = True
                        tempp_kalkun.isBlinking = False
                        tempp_kalkun.movement[1] = -1*tempp_kalkun.jumpSpeed
        ...
        clock.tick(FPS)
        if tempp_kalkun.isJumping == False and tempp_kalkun.isBlinking == False:
            gameStart = True
...
def gameplay():
    ...
    while not gameQuit:
        ...
        while not gameOver:
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.KEYDOWN:
                        ...
                        if event.key == pygame.K_DOWN:
                            if not (playerKalkun.isJumping and playerKalkun.isDead):
                                playerKalkun.isDucking = True

                    if event.type == pygame.KEYUP:
                        if event.key == pygame.K_DOWN:
                            playerKalkun.isDucking = False
            for c in cacti:
            ...
            if playerKalkun.isDead:
                gameOver = True
                if playerKalkun.score > high_score:
                    high_score = playerKalkun.score
